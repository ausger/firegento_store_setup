    ...
    extends FireGento_MageSetup_Block_Bundle_Catalog_Product_Price_Abstract
{
    ...
    public function _toHtml()
    {
        ...
        $html .= $this->getLayout()->createBlock('core/template')
            ...
            ->setExclusiveTaxLabel($this->getExclusiveTaxLabel())
            ->setInclusiveTaxLabel($this->getInclusiveTaxLabel())
            ->toHtml();
    ...
    public function getExclusiveTaxLabel()
    {
    ...
    public function getInclusiveTaxLabel()
    {
        if($this->getTaxRate() == 0) {
            return "Incl. Tax";
        } else {
